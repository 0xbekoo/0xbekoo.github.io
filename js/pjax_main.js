(() => {
  ...
  document.getElementById("main-nav-toggle")?.off("click").on("click", function() {
  ...
  document.getElementById("mask")?.off("click").on("click", function() {
  ...
  function tocInit() {
    ...
    const activateNavByIndex = (index) => {
      ...
      if (!document.querySelector(".sidebar-toc-sidebar").classList.contains("hidden")) {
